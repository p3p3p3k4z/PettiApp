...
foreach ($productos['productos'] as $producto) {
    ...
    // Insertar producto con el campo 'empleado' en la tabla productos_cocina
    $query = "INSERT INTO productos_cocina (codigo, nombre, categoria, empleado) VALUES ('$codigo', '$nombre', '$categoria', '$empleado')";
